...
Over the course of two days, you will develop your solutions, addressing the **9 (?)** topics outlined in the **guidelines** **(add link to updated version)**. You will work in teams taking different approaches to said topics. You can develop a conceptual, clickable, and/or technical prototype. Either way, you should clearly present the interactions and data flows between actors, software, and infrastructure components over time, as well as the user experience of these actors. **Proper documentation is key to ensuring that your solution can be understood and evaluated. DELETE** 
